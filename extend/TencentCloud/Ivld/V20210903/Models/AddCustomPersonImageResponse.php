 ...
 * @method PersonImageInfo getImageInfo() 获取自定义人脸图片信息
 * @method void setImageInfo(PersonImageInfo $ImageInfo) 设置自定义人脸图片信息
...
class AddCustomPersonImageResponse extends AbstractModel
{
     ...
     * @param PersonImageInfo $ImageInfo 自定义人脸图片信息
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("ImageInfo", $param) and $param["ImageInfo"] !== null) {
            $this->ImageInfo = new PersonImageInfo();
