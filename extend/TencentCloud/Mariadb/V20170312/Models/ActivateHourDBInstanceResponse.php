 ...
 *
 * @method array getSuccessInstanceIds() 获取隔离成功的实例id列表
 * @method void setSuccessInstanceIds(array $SuccessInstanceIds) 设置隔离成功的实例id列表
 * @method array getFailedInstanceIds() 获取隔离失败的实例id列表
 * @method void setFailedInstanceIds(array $FailedInstanceIds) 设置隔离失败的实例id列表
...
{
    /**
     * @var array 隔离成功的实例id列表
     */
    public $SuccessInstanceIds;

    /**
     * @var array 隔离失败的实例id列表
     */
    ...
    /**
     * @param array $SuccessInstanceIds 隔离成功的实例id列表
     * @param array $FailedInstanceIds 隔离失败的实例id列表
