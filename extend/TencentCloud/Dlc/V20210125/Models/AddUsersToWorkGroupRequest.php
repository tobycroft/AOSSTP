 ...
 *
 * @method UserIdSetOfWorkGroupId getAddInfo() 获取要操作的工作组和用户信息
 * @method void setAddInfo(UserIdSetOfWorkGroupId $AddInfo) 设置要操作的工作组和用户信息
 */
class AddUsersToWorkGroupRequest extends AbstractModel
{
    /**
     * @var UserIdSetOfWorkGroupId 要操作的工作组和用户信息
     */
    public $AddInfo;

    /**
     * @param UserIdSetOfWorkGroupId $AddInfo 要操作的工作组和用户信息
     */
