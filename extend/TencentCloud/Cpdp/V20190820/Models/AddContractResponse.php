 ...
 * @method AddContractResult getResult() 获取添加合同响应对象
 * 注意：此字段可能返回 null，表示取不到有效值。
 * @method void setResult(AddContractResult $Result) 设置添加合同响应对象
 * 注意：此字段可能返回 null，表示取不到有效值。
...
class AddContractResponse extends AbstractModel
{
    ...
    /**
     * @var AddContractResult 添加合同响应对象
     * 注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Result;
     ...
     * @param AddContractResult $Result 添加合同响应对象
     * 注意：此字段可能返回 null，表示取不到有效值。
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Result", $param) and $param["Result"] !== null) {
            $this->Result = new AddContractResult();
