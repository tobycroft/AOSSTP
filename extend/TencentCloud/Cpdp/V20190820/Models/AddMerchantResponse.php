 ...
 * @method AddMerchantResult getResult() 获取添加商户响应对象
 * 注意：此字段可能返回 null，表示取不到有效值。
 * @method void setResult(AddMerchantResult $Result) 设置添加商户响应对象
 * 注意：此字段可能返回 null，表示取不到有效值。
...
class AddMerchantResponse extends AbstractModel
{
    ...
    /**
     * @var AddMerchantResult 添加商户响应对象
     * 注意：此字段可能返回 null，表示取不到有效值。
     */
    public $Result;
     ...
     * @param AddMerchantResult $Result 添加商户响应对象
     * 注意：此字段可能返回 null，表示取不到有效值。
    ...
    public function deserialize($param)
    {
        ...
        if (array_key_exists("Result", $param) and $param["Result"] !== null) {
            $this->Result = new AddMerchantResult();
