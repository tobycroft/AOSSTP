 ...
 * @method AddShopResult getResult() 获取添加申请响应对象
 * 注意：此字段可能返回 null，表示取不到有效值。
 * @method void setResult(AddShopResult $Result) 设置添加申请响应对象
 * 注意：此字段可能返回 null，表示取不到有效值。
...
class AddShopResponse extends AbstractModel
{
     ...
     * @param AddShopResult $Result 添加申请响应对象
     * 注意：此字段可能返回 null，表示取不到有效值。
