 ...
 * AddAcRule返回参数结构体
 *
 * @method integer getRuleUuid() 获取创建成功后返回新策略的uuid
 * @method void setRuleUuid(integer $RuleUuid) 设置创建成功后返回新策略的uuid
...
class AddAcRuleResponse extends AbstractModel
{
    ...
    /**
     * @param integer $RuleUuid 创建成功后返回新策略的uuid
