 ...
 *
 * @method array getSuccessInstanceIds() 获取解隔离成功的实例id列表
 * @method void setSuccessInstanceIds(array $SuccessInstanceIds) 设置解隔离成功的实例id列表
 * @method array getFailedInstanceIds() 获取解隔离失败的实例id列表
 * @method void setFailedInstanceIds(array $FailedInstanceIds) 设置解隔离失败的实例id列表
...
{
    /**
     * @var array 解隔离成功的实例id列表
     */
    public $SuccessInstanceIds;

    /**
     * @var array 解隔离失败的实例id列表
     */
    ...
    /**
     * @param array $SuccessInstanceIds 解隔离成功的实例id列表
     * @param array $FailedInstanceIds 解隔离失败的实例id列表
