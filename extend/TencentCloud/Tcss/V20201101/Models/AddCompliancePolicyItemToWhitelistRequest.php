 ...
 *
 * @method array getCustomerPolicyItemIdSet() 获取要忽略的检测项的ID的列表
 * @method void setCustomerPolicyItemIdSet(array $CustomerPolicyItemIdSet) 设置要忽略的检测项的ID的列表
 */
class AddCompliancePolicyItemToWhitelistRequest extends AbstractModel
{
    /**
     * @var array 要忽略的检测项的ID的列表
     */
    public $CustomerPolicyItemIdSet;

    /**
     * @param array $CustomerPolicyItemIdSet 要忽略的检测项的ID的列表
     */
