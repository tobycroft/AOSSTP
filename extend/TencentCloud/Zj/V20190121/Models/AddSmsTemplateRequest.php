 ...
 * @method string getTemplateContent() 获取短信内容，动态内容使用占位符{
1
}，{
2
}等表示
 * @method void setTemplateContent(string $TemplateContent) 设置短信内容，动态内容使用占位符{
1
}，{
2
}等表示
 ...
 * @method array getCommonParams() 获取发送短信活动时用于展示人群包动态参数模板占位符序号或接口发送时变量占位符序号
 * @method void setCommonParams(array $CommonParams) 设置发送短信活动时用于展示人群包动态参数模板占位符序号或接口发送时变量占位符序号
...
class AddSmsTemplateRequest extends AbstractModel
{
    ...
    /**
     * @var array 发送短信活动时用于展示人群包动态参数模板占位符序号或接口发送时变量占位符序号
     */
    public $CommonParams;
     ...
     * @param array $CommonParams 发送短信活动时用于展示人群包动态参数模板占位符序号或接口发送时变量占位符序号
