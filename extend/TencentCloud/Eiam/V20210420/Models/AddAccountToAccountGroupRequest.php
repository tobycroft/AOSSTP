 ...
 * @method array getAccountIds() 获取加入账号组的账号ID列表。
 * @method void setAccountIds(array $AccountIds) 设置加入账号组的账号ID列表。
 */
class AddAccountToAccountGroupRequest extends AbstractModel
{
    ...
    /**
     * @var array 加入账号组的账号ID列表。
     */
    public $AccountIds;

    /**
     * @param string $AccountGroupId 账号组ID
     * @param array $AccountIds 加入账号组的账号ID列表。
     */
