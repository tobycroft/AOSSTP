 ...
 * 前缀匹配：matching
 * 内容为空或不存在：null
 * @method void setLogicOperator(string $LogicOperator) 设置逻辑操作符，取值如下：
 * 不包含：exclude
 * 包含：include
 * 不等于：notequal
 * 等于：equal
 ...
 * 当MatchKey为index时
 * 取值为：/;/index.html
 * @method boolean getCaseSensitive() 获取是否区分大小写 true：区分 false：不区分
 * @method void setCaseSensitive(boolean $CaseSensitive) 设置是否区分大小写 true：区分 false：不区分
 * @method string getMatchKeyParam() 获取当MatchKey为param时必填：表示请求参数Key 当MatchKey为cookie时必填：表示请求头Cookie中参数的
 * @method void setMatchKeyParam(string $MatchKeyParam) 设置当MatchKey为param时必填：表示请求参数Key 当MatchKey为cookie时必填：表示请求头Cookie中参数的
 */
class AdvancedScdnAclRule extends AbstractModel
{
    ...
    /**
     * @var boolean 是否区分大小写 true：区分 false：不区分
     */
    public $CaseSensitive;

    /**
     * @var string 当MatchKey为param时必填：表示请求参数Key 当MatchKey为cookie时必填：表示请求头Cookie中参数的
     */
     ...
     * 当MatchKey为index时
     * 取值为：/;/index.html
     * @param boolean $CaseSensitive 是否区分大小写 true：区分 false：不区分
     * @param string $MatchKeyParam 当MatchKey为param时必填：表示请求参数Key 当MatchKey为cookie时必填：表示请求头Cookie中参数的
     */
